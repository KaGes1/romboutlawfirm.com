    ...
    let n = {
        ...
        Image_Accordion: function(t) {
            ...
            t.on("click", ".ekit-image-accordion-item", (function(t) {
                ...
                if ("hover" === o || i === this) !l && a ? .url && window.open(a.url, r);
                else {
            ...
            if (t.find(".ekit-nav-dropdown-click").length > 0) {
                ...
                t.on("click", ".elementskit-dropdown-has > a", (function(i) {
                    ...
                    let a = e(this).parent(),
                        ...
                        s = a.find(">.elementskit-dropdown, >.elementskit-megamenu-panel");
        ...
        Progressbar: function(e) {
            ...
            t.elementorWaypoint((function() {
                i.animateNumbers(a, !0, o), n.animate({
                    width: a + "%"
                }, o)
            }), {
                offset: "100%"
        ...
        Funfact: function(e) {
            ...
            t.elementorWaypoint((function() {
                "static" == i ? n.animateNumbers(a, !0, o) : new Odometer({
                    el: n[0],
                    value: 0,
                    duration: o
                }).update(a)
        ...
        Countdown_Timer: function(t) {
            ...
            if (n.length) {
                switch (n[0].classList[0]) {
                    ...
                    case "elementskit-countdown-timer-3":
                        i.markup = '<div class="elementskit-timer-container elementskit-days"><div class="' + s + '"><div class="' + o + '"><span class="elementskit-timer-count">%-D </span><span class="elementskit-timer-title">' + i.dateEkitDay + '</span></div></div></div><div class="elementskit-timer-container elementskit-hours"><div class="' + s + '"><div class="' + o + '"><span class="elementskit-timer-count">%H </span><span class="elementskit-timer-title">' + i.dateEkitHour + '</span></div></div></div><div class="elementskit-timer-container elementskit-minutes"><div class="' + s + '"><div class="' + o + '"><span class="elementskit-timer-count">%M </span><span class="elementskit-timer-title">' + i.dateEkitMinute + '</span></div></div></div><div class="elementskit-timer-container elementskit-seconds"><div class="' + s + '"><div class="' + o + '"><span class="elementskit-timer-count">%S </span><span class="elementskit-timer-title">' + i.dateEkitSecond + "</span></div></div></div>"
                }
            ...
            if (l.length) {
                ...
                l.theFinalCountdown(r.ekitCountdown, (function(e) {
                    m(c.s, e.offset.seconds, a), m(c.m, e.offset.minutes, i), m(c.h, e.offset.hours, o), m(c.d, e.offset.days, s), m(c.w, e.offset.weeks, d), c.s = e.offset.seconds, c.m = e.offset.minutes, c.h = e.offset.hours, c.d = e.offset.days, c.w = e.offset.weeks
                })).on("finish.countdown", (function() {
        ...
        Video: function(t) {
            var n = t.find(".self_video_wrapper"),
                i = n.data("video-player"),
                a = n.data("video-setting");
            n.length > 0 && (t.find(".self-media").magnificPopup({
                type: "inline",
                mainClass: "ekit_self_video_wrap_content",
                callbacks: {
                    open: function() {
                        e("body").find(".mfp-close").addClass("ekit-popup-close-self"), window.dispatchEvent(new Event("resize"))
                    },
                    close: function() {
                        e("body").find(".mfp-close").removeClass("ekit-popup-close-self"), t.find("video").each((function() {
                            this.pause()
                        }))
                    }
                }
...
function(e) {
    ...
    e.fn.animateNumbers = function(t, n, i, a) {
        return this.each((function() {
            var o = e(this),
                s = parseInt(o.text().replace(/,/g, ""), 10);
            n = n === undefined || n, e({
                value: s
            }).animate({
                value: t
